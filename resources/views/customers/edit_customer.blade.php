...
@section('title')
تعديل عميل - مورا سوفت للادارة القانونية
@stop
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    action="{{route('customers.update', [$cust->id])}}" method="post">
                    {{csrf_field()}}
                    {{ method_field('put') }}
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="name_customer" required="" type="text" value="{{$cust->name_customer}}">
                            </div>

                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                <label>رقم الهاتف: <span class="tx-danger">*</span></label>
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="phone_customer" required="" type="number" value="{{$cust->phone_customer}}">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description"  name="note_customer" rows="3"
                          >{{$cust->note_customer}}</textarea>
                    </div>
