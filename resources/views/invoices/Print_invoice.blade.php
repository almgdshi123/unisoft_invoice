...
@section('content')
    ...
    <div class="row row-sm">
        <div class="col-md-12 col-xl-12">
            <div class=" main-content-body-i-nvoice" id="print">
                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                ...
                                <p><br>
                                    هاتف: 7733432010<br>
                                   ايميل : good.mmm9999@gamil.com</p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>اسم العميل</span>
                                    <span>{{  $invoices->customer->name_customer}}</span>
                                </p>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="tx-right">مبلغ الموجود  في الحساب</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        @if($invoices->product==null)
                                        <td class="tx-12">فاتورة دين مستحقه</td>
                                        @else
                                        <td class="tx-12">{{ $invoices->product }}</td>
                                        @endif
                                        <td class="tx-center">{{ number_format($invoices->Amount_collection, 2) }}</td>
                                        <td class="tx-right">{{ number_format($dep_acc->Total, 2) }}</td>
                                    ...
                                    <tr>
                                        <td class="valign-middle" colspan="2" rowspan="4">
                                            <div class="invoice-notes">
                                                <label class="main-content-label tx-13">التواصل بسرع وقت للتحقق من الفاتورة </label>

                                            </div><!-- invoice-notes -->
                                        </td>
                                        <td class="tx-right">الاجمالي الاضافة</td>
                                        <td class="tx-right" colspan="2"> {{ number_format($dep_acc->Amount_Commission+$invoices->Amount_collection, 2) }}</td>
                                    </tr>
                                
                    
                                    <tr>
                                        <td class="tx-right tx-uppercase tx-bold tx-inverse">الاجمالي شامل الحساب</td>
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">{{ number_format($box->Total, 2) }}</h4>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
