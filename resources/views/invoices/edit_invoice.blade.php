                        ...
                        <form action="{{ url('invoices/update') }}" method="post" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <select required name="Custmoer" class="form-control select2" onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')">
                                        <!--placeholder-->
                                            <option value=" {{ $invoices->customer->id }}">
                                                {{ $invoices->customer->name_customer }}
                                            </option>
                                      
                                            @foreach ($custmoers as $custmoers)
                                            <option value="{{ $custmoers->id }}"> {{ $custmoers->name_customer }}</option>
                                        @endforeach
                                        <option></option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                        ...
                                        value="{{ $invoices->Amount_collection }}" required  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                                </div>
                            </div>
